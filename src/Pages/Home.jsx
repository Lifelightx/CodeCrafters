    ...
    <div className='min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-r from-blue-100 to-white p-4'>
      <img src={CodeCrafter} alt="CodeCrafter" className='w-24 h-24 mb-4' />
       ...
       <div className='flex flex-col sm:flex-row gap-4'>
        <Link to='/learn' className='bg-blue-500 text-slate-100 px-4 py-2  rounded-md hover:bg-white hover:text-blue-500 transition-colors duration-300 text-sm sm:text-base flex items-center justify-center gap-2'>
          <i className="fas fa-laptop-code"></i>
          Interview Preparation
        </Link>
        <Link to='/courses' className='bg-blue-500 text-slate-100 px-4 py-2 rounded-md hover:bg-white hover:text-blue-500 transition-colors duration-300 text-sm sm:text-base flex items-center justify-center gap-2'>
